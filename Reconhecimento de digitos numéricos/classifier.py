...
class ImageClassifier:
    ...
    def __init__(self):
        ...
        self.classes = []
        self.num_classes = 0
        # 20% dos dados são usados para validação
    ...
    def load_data(self):
        ...
        print("Leitura completa dos dados de entrada:")
        print("Número de arquivos no conjunto de treinamento:\t\t{}".format(len(self.data.train.labels)))
        print("Número de arquivos no conjunto de validação:\t{}".format(len(self.data.valid.labels)))
    ...
    def show_progress(self, epoch, feed_dict_train, feed_dict_validate, val_loss):
        ...
        msg = "Época de Treinamento {0} --- Acurácia do treinamento: {1:>6.1%}, "
